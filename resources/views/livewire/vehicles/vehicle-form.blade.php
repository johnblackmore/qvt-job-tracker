<div class="max-w-lg">
    <div class="mb-8">
        <div class="flex items-center gap-2 mb-2">
            <a href="{{ route('customers.show', $customer) }}" wire:navigate class="text-sm text-slate-500 hover:text-copper transition-colors">
                {{ $customer->name }}
            </a>
    ...
    <form wire:submit="save" class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-5">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                ...
                <input wire:model="make" id="make" type="text" class="w-full rounded-lg border-slate-300 text-slate-900 focus:border-copper focus:ring-copper text-sm px-3.5 py-2.5" placeholder="Ford, VW, Mercedes..." />
            ...
            <div>
                ...
                <input wire:model="model" id="model" type="text" class="w-full rounded-lg border-slate-300 text-slate-900 focus:border-copper focus:ring-copper text-sm px-3.5 py-2.5" placeholder="Transit, Transporter..." />
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                ...
                <input wire:model="registration" id="registration" type="text" class="w-full rounded-lg border-slate-300 text-slate-900 focus:border-copper focus:ring-copper text-sm px-3.5 py-2.5" placeholder="AB12 CDE" />
            ...
            <div>
                ...
                <input wire:model="year" id="year" type="text" class="w-full rounded-lg border-slate-300 text-slate-900 focus:border-copper focus:ring-copper text-sm px-3.5 py-2.5" placeholder="2022" />
        ...
        <div>
            ...
            <select wire:model="type" id="type" class="w-full rounded-lg border-slate-300 text-slate-900 focus:border-copper focus:ring-copper text-sm px-3.5 py-2.5">
        ...
        <div>
            ...
            <textarea wire:model="notes" id="notes" rows="3" class="w-full rounded-lg border-slate-300 text-slate-900 focus:border-copper focus:ring-copper text-sm px-3.5 py-2.5" placeholder="Any details about this vehicle..."></textarea>
